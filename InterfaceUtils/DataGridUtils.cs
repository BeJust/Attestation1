...
namespace InterfaceUtils
{
    public class DataGridUtils
    {
        ...
        public static void CarriageListToGrid(DataGridView dgv, List<Carriage> data)
        {
            ...
            for (int r = 0; r < rowCount; r++)
            {
                dgv[0, r].Value = data[r].Number;
                dgv[1, r].Value = data[r].PassNum;
                dgv[2, r].Value = data[r].LuggAmount;
                dgv[3, r].Value = data[r].Comfort;
            }
        }
